...
public class Bootstrap {
    ...
    @Transactional
    void bootstrapData() {
        this.addUser(new UserEntity("admin", "admin", "admin@fmail.com", "admin", Role.LIBRARIAN, true));
        this.addUser(new UserEntity("Karol", "Nowacki", "karol.nowacki@fmail.com", "password", Role.LIBRARIAN, true));
        this.addUser(new UserEntity("Andrzej", "Nowak", "andrze.nowak@fmail.com", "password", Role.USER, true));
        this.addUser(new UserEntity("Władysław", "Mol", "władek2137@fmail.com", "password", Role.USER, true));
