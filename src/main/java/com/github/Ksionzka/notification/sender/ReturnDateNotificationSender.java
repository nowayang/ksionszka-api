...
public class ReturnDateNotificationSender implements ApplicationListener<ReturnDateNotification> {
    ...
    public void onApplicationEvent(ReturnDateNotification event) {
        ...
        emailSender.send(loanEntity.getUser().getEmail(), getMessage(loanEntity), "Przypomnienie o zwrocie");
    }

    public String getMessage(LoanEntity loan) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Przypomnienie o nadchodzącym terminie zwrotu</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
