...
public class LoanController implements BaseController<LoanEntity, Long> {
    ...
    public Page<LoanEntity> findAll(Pageable pageable, @RequestParam(required = false) String search,
                                    ...
                                    @RequestParam(required = false) Boolean requestedExtension) {
        ...
        if (Objects.nonNull(requestedExtension)) {
            Specification<LoanEntity> returnedSpec = LoanSpecifications.isRequestedExtension();
            specification = specification.and(requestedExtension ? returnedSpec : Specification.not(returnedSpec));
        }
