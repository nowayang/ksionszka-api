...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        emailSender.send(request.getEmail(), buildEmail(request.getFirstName(), link), "Potwierdź swój email");
